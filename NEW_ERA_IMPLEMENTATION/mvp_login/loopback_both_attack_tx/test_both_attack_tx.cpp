...
int main() {
    ...
    assert(BuildAttack1(0x0701, 0x78, 0x03, out, error));
    Expect(out, {0x08,0x00,0x07,0x00,0x00,0x00,0xC1,0x07,0x11,0x07,0x01,0x78,0x03});

    assert(BuildAttack2(0x0109, 0x32, 0x3C, 0x01, 0x09, out, error));
    Expect(out, {0x09,0x00,0x09,0x00,0x00,0x00,0xC3,0x09,0xDB,0x01,0x09,0x32,0x01,0x3C});
